...
char nam[] = "ABCDEFGHIJK";//문자열 포인터로 변경 : "박지호", "박지일", "박지이", "박지삼", "박지사", "박지오", "박지육", "박지칠", "박지팔", "박지구" 
const char* name[] = { "박지호", "박지일", "박지이", "박지삼", "박지사", "박지오", "박지육", "박지칠", "박지팔", "박지구" };
STU student[nArr];
...
void StreamTest()
{
	...
	float d;
	char buf[1024];
	FILE* fin = fopen("C:\\Users\\jiho9\\aa", "r");  // 만약 파일이 존재하지 않으면 NULL 반환
	FILE* fout = fopen("C:\\Users\\jiho9\\aa.o", "w+b");
	if (fin != NULL)
	{
